...
# esta función se encarga de recibir el mensaje completo desde el cliente en caso de que el 
# mensaje sea más grande que el tamaño del buffer 'buff_size', esta función va esperar a que 
# llegue el resto. Para saber si el mensaje ya llegó por completo, se busca el caracter de fin 
# de mensaje (parte de nuestro protocolo inventado)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # cerramos la conexión notar que la dirección que se imprime indica un número de puerto distinto al 5000
        new_socket.close()
